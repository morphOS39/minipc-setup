...
echo ""
echo "Stick einstecken, dann mit lsblk das Device finden (z.B. /dev/sdb1)."
echo ""
echo "Stick formatieren und labeln:"
echo "  sudo mkfs.ext4 -L BACKUP-A /dev/sdX1"
echo "  (zweiten Stick spaeter mit BACKUP-B)"
echo ""
...
echo "  1. USB-Stick formatieren und labeln (siehe oben)"
echo "  2. Testlauf: $SCRIPT_PATH"
